(function () {
  ...
  const ZESTAWY = [
    {
      ...
      zdania: [
        ...
        { zdanie: 'It ____ expensive but it is cool.', odpowiedz: "isn't",
          ...
          wyjasnienie: 'Przy "it" mówimy "is", a przeczenie to "isn\'t" - w tym zdaniu pasują obie formy.', unit: 3 },
        ...
        { zdanie: 'He ____ kayaking.', odpowiedz: "isn't",
          takze_poprawne: ['is'],
          dystraktory: ["aren't", 'am not', "doesn't"],
          wyjasnienie: 'Przy "he" mówimy "is" + -ing, a przeczenie to "isn\'t" - tu pasują obie formy.', unit: 8 },
        ...
        { zdanie: 'I ____ got a helmet on my head.', odpowiedz: "haven't",
          ...
          wyjasnienie: 'Przy "I" mówimy "have got", a przeczenie to "haven\'t got" - tu pasują obie formy.', unit: 7 },
  ...
  function zbudujPytanie(idZestawu, tryb, z) {
    ...
    return {
      ...
      // Dodatkowe akceptowane odpowiedzi — patrz `pasuje` w js/walka.js.
      // Świadomie NIE wchodzą do `warianty`: lista czterech przycisków w trybie
      // wyboru zostaje bez zmian, bo tam dystraktory nadal zawężają pole.
      takze_poprawne: z.takze_poprawne || null,
