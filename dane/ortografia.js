  ...
  const ZESTAWY = [
    {
      ...
      warianty: ['ó', 'u'],
      wyrazy: [
        { wyraz: 'król',     luka: 2, poprawny: 'ó', zasada: 'ó wymienia się na o: król — królowa' },
        ...
        { wyraz: 'góra',     luka: 1, poprawny: 'ó', zasada: 'wyjątek — ó trzeba zapamiętać (góra, górka, górski)' },
        ...
        { wyraz: 'ulica',    luka: 0, poprawny: 'u', zasada: 'na początku wyrazu piszemy u (poza: ósemka, ów)' },
        { wyraz: 'uczeń',    luka: 0, poprawny: 'u', zasada: 'na początku wyrazu piszemy u (poza: ósemka, ów)' },
    ...
    },
    {
      ...
      wyrazy: [
        ...
        { wyraz: 'wożę',      luka: 2, poprawny: 'ż',  zasada: 'ż wymienia się na z: wożę — wozić' },
        { wyraz: 'żaba',      luka: 0, poprawny: 'ż',  zasada: 'ż się nie wymienia — trzeba zapamiętać (żaba, żubr)' },
        { wyraz: 'żyrafa',    luka: 0, poprawny: 'ż',  zasada: 'ż się nie wymienia — trzeba zapamiętać' },
        { wyraz: 'żółty',     luka: 0, poprawny: 'ż',  zasada: 'ż się nie wymienia — trzeba zapamiętać' },
        { wyraz: 'każdy',     luka: 2, poprawny: 'ż',  zasada: 'ż się nie wymienia — trzeba zapamiętać' },
      ],
    },
    {
      id: 'ch-h',
      ...
      wyrazy: [
        ...
        { wyraz: 'schody',   luka: 1, poprawny: 'ch', zasada: 'po literze s piszemy ch: schody, schować' },
        { wyraz: 'chleb',    luka: 0, poprawny: 'ch', zasada: 'wyjątek — ch trzeba zapamiętać (chleb, chmura, chata)' },
        { wyraz: 'chmura',   luka: 0, poprawny: 'ch', zasada: 'wyjątek — ch trzeba zapamiętać' },
        { wyraz: 'chata',    luka: 0, poprawny: 'ch', zasada: 'wyjątek — ch trzeba zapamiętać' },
